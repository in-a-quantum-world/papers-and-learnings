...
| [ML tools](ml-tools/) | 5 | A collection of practical tools and platforms: Gymnasium, OpenCV, Palantir AIP, tutorials. |
| [Robotics, simulations](robotics-simulations/) | 5 | Physical AI, simulation (Isaac Sim), humanoids, and robotics challenges. |
| [Calls for Papers](calls-for-papers/) | 5 | Open CFPs, submission portals and deadline trackers — where I could actually submit, not just what I could read. |
